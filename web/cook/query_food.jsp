...
<nav style="height: 450px;">
	<ul>
		...
		<li>
			<a href="/RestaurantSystem/servlet/OrderServlet?action=comlpetedOrder"><span class="icon">&#127748;</span> 已完成订单</a>
			<ul class="submenu">
			</ul>
		</li>
		<li>
				...
				<thead style="text-align: center;">
					...
					%>
						<tr>
							...
							<td><a href="/servlet/FoodOperateServlet?action=cookUpdateState&id=<%=liFood.getId()%>"><%=liFood.getFood_state()==2?"下架":"上架" %></a></td>
						</tr>
						<%
							}
						}
