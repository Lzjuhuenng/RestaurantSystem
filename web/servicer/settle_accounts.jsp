		...
		<header>
			<hgroup>
				<div style="padding-top: 5px;">
					<font size="5" color="#F7FfFf">结账</font>					
				</div>
			</hgroup>
		</header>
		<div class="content">
				...
				<thead style="text-align: center;">
					<tr>
						...
						<th style="text-align: center;padding-left:15px;padding-right:15px;">消费金额</th>
						<th style="background-image: none;text-align: center;padding-left: 15px;padding-right:15px;">详情</th>
						<th style="background-image: none;text-align: center;padding-left: 15px;padding-right:15px;">结账</th>
					</tr>
				</thead>
					...
					%>
						<tr>
							...
							<td><a href="/servlet/OrderServlet?action=settleAccount&orderId=<%=order.getId()%>">结账</a></td>
						</tr>
						<%
							}
						}
